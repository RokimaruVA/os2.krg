const langArr = {
  ...
  "qna-intro": {
    "kz": 'Сұрақтарыңыз болса,  жауаптарын төменде таба аласыз <br /> телефон арқылы сұрақ қою <a href="tel:87212604479" class="link link-in-text hidden-desktop"> 8 7212 60 44 79</a > <a id="copy-text-3" class="link link-in-text hidden-mobile"><span id="text-3">8 7212 60 44 79</span></a > <br /> немесе электронды пошта арқылы <a id="copy-text-4" class="link link-in-text" ><span id="text-4">ddu_new@kargoo.kz</span></a >',
  ...
  "answer-four": {
    "kz": "Е-дарын сайтында үйірмелерді таңдау кезінде педагогтің байланыс нөмірі сабақ туралы  ақпаратпен бірге көрсетіледі.",
  ...
  "competitions-intro": {
    "kz": "Біз дағдыларды дамытуға ғана емес, сонымен қатар жеке өсуге де ықпал ететін көптеген байқаулар, жарыстар мен жобаларды ұсынамыз. Мұнда сіз оқушылардың таланттары мен дағдыларын дамытуға арналған іс-шараларды таба аласыз.",
  ...
  "admin-post-1": {
    ...
    "ru": "Заместитель директора по учебной части",
  ...
  "admin-post-2": {
    "kz": "Директордың ғылыми-әдістемелік ісі жөніндегі міндетін атқарушысы",
    "ru": "Исполняющий обязанности директора по научно-методической работе",
    "en": "Acting Director for Scientific and Methodological Work",
  },
  "admin-name-2": {
  ...
  "org-name-description": {
    "kz": 'Коммуналдық мемлекеттік мекеме "№2 оқушылар сарайы"<br / > <br /  мемлекеттік коммуналдық қазыналық кәсіпорын',
    "ru": 'Коммунальное государственное учреждение "Дворец школьников №2"<br /> <br />отдела образования города Караганды',
  ...
  "staffing-description": {
    "kz": "ӘБП штаттық кестесі бойынша 5 бірлік <br/> техникалық персонал 30 бірлік <br/> педагогикалық құрам 85 бірлік .",
